...
app = Flask(__name__)
socketio = SocketIO(app, cors_allowed_origins=["http://192.168.2.100:3000", "https://bobik.lan","https://192.168.99.5"], ping_timeout=11, ping_interval=5, async_mode="threading")
thread = None

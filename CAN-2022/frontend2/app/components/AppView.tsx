...
import { setStatus, setIsConnected, setPastEvents, setAlarmProfiles, setIsError } from "./AppStateSlice";
...
const AppView: React.FC = () => {
    const appState = useSelector((state: object) => state.appState); //appState is the name of the slice
